...
The transported scalar :math:`N_\alpha` is treated as the specific activity of a
radioactive species and is modeled as a passive scalar that does not alter the
underlying flow or transport processes. In addition, only radioisotopes
generated by single-step reactions and with constant parent concentration are
considered.
