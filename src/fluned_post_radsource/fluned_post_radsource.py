...
from flundePost import flunedPost
...
def main():
    ...
    parser.add_argument(
        "-v", "--vtk", type=str, help="vtk file to sample", default=False
    )
    parser.add_argument("--cdgs", action="store_true", help="print cdgs", default=False)
    parser.add_argument(
        "--openmc",
        action="store_true",
        help="generate openmc mesh-based source",
        default=False,
    )
    parser.add_argument(
    ...
    simCase = flunedPost(simulationFolder)
