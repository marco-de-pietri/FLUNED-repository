...
.. figure:: _static/circuit.png
   :alt: FNG-2019 Water Activation experimental Circuit.
   :width: 70%
   :align: center

   FNG-2019 Water Activation experimental Circuit.

   FNG-2019 Water Activation experimental Circuit test.
...
.. figure:: _static/results.png
   ...
   FLUNED simulation results against the FNG-2019 Water Activation experimental measurements test.
